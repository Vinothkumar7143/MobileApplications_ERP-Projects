...
import 'package:kfti/outward.dart';
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Text('Material Inward',style: TextStyle(fontSize: 25,decoration: TextDecoration.underline,fontWeight: FontWeight.bold),),
            ),
            Container(
              ...
              child: Table(
                ...
                children: [
                  ...
                  TableRow( children: [
                    Column(children:[Text('$material',style: TextStyle(color: Colors.green,fontSize: 20.0),)]),
                    Column(children:[Text('$partno',style: TextStyle(color: Colors.green,fontSize: 20.0))]),
                  ]),
                ],
              ),
            ),
            Container(
              ...
              child: Table(
                ...
                children: [
                  ...
                  TableRow( children: [
                    Column(children:[Text('$partname',style: TextStyle(color: Colors.green,fontSize: 20.0))]),
                    Column(children:[Text('$qty',style: TextStyle(color: Colors.green,fontSize: 20.0))]),
                  ]),
                ],
              ),
            ),
